...
install -v -m 755 virtualplanet/library/plan404/libplan404.dylib  $destdir/libplan404.dylib
...
install -v -m 644 vpa/language/maplun.en.po $destdir/language/
install -v -m 644 vpa/language/maplun.fr.po $destdir/language/
